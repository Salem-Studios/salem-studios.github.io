    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#1f0f07] to-[#3e1f13] text-white font-jacquard px-4 relative overflow-hidden">
      ...
      {showSettings && (
        <>
          ...
          {/* Modal panel */}
          <div className="absolute top-1/2 left-1/2 w-[90vw] max-w-xl -translate-x-1/2 -translate-y-1/2 bg-[#2c1a12] p-8 border-4 border-[#bfa77a] rounded-2xl shadow-2xl z-20">
            ...
            <button
              ...
              className="mt-8 w-full text-3xl px-4 py-3 bg-[#462a1f] border-4 border-[#bfa77a] rounded-l hover:bg-[#654532] transition-all"
            >
              Close
            </button>
          </div>
